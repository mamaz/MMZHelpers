...
- (UIActivityIndicatorView *)activityIndicatorView
{
    ...
    if (!activityIndicatorView) {
        ...
        CGSize loadingSize = CGSizeMake(50, 50);
        CGFloat padding = 50;
        activityIndicatorView = [[UIActivityIndicatorView alloc]initWithFrame:CGRectMake(self.frame.size.width/2 - loadingSize.width/2, self.frame.size.height/2 - loadingSize.height/2 - padding, loadingSize.width,loadingSize.height)];
